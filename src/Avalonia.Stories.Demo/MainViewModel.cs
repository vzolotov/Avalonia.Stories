...
public class MainViewModel : ReactiveObject, IStoriesViewModel
{
    ...
    public MainViewModel()
    {
        ...
        Items.Add(new StoriesImageViewModel("2222", new Uri("https://avaloniaui.net/assets/fidelityapps.png")));
        Items.Add(new StoriesImageViewModel("3333", new Uri("https://miro.medium.com/max/877/1*JNMfTWCIwVtNab7cdhUfzA.png")));
    }
}